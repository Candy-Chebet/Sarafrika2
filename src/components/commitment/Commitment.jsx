...
const items = [
  {
    ...
    desc: [
      'Providing access to high quality music knowledge and experiences to a wide regional demographic with a special attention to youth, children and those with special needs.',
  ...
  },
  {
    ...
    desc: [
      'Sharing music industry information, resources and research, and nurture connections with local and regional arts organisations and enterprises.',
  ...
  },
  {
    ...
    desc: [
      'We Work with the regional media to develop and produce music programming formats.',
  ...
  },
  {
    ...
    desc: [
      'Providing music and sports practitioners with training in communication, business administration, finance and technical skills.',
  ...
  },
  {
    ...
    desc: [
      'In conjunction with selected institutions, we work to develop a repository of regional music, sports, culture, practice, norms, record of instruments for public record and access purposes.',
  ...
  },
  {
    ...
    desc: [
      'Support distinct community initiatives seeking to develop micro-economies through the arts.',
...
const Commitment = () => (
  <div className="commitment" id="commitment">
