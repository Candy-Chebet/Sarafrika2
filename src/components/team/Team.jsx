    ...
    <div className="team-container">
      ...
      <div className="services">
        <div className="service" onClick={() => setShowModal1(true)}>
          <img src="project_modern_ui_ux_gpt3\src\assets\Team\Raphael.JPG" alt="Raphael Njuguna" />
          <h3>Raphael Njuguna</h3>
          <h4>Managing Director & Founding Director</h4>
        </div>
      ...
      {showModal1 && (
        <div className="modal-overlay" onClick={() => setShowModal1(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <img src="project_modern_ui_ux_gpt3\src\assets\Team\Raphael.JPG" alt="Winnie Joyce" />
            <h3>Raphael Njuguna</h3>
            <h4>Managing Director & Founding Director</h4>
            <p>
